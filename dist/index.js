  ...
  _createClass(SocialFeedAPI, [{
    ...
    value: function getFeeds(accessTokens) {
      ...
      return new Promise(function (fulfill, reject) {
        Promise.all(
          [
            _this3.facebook ? _this3.facebook.fetch() : Promise.resolve(null), 
            _this3.twitter ? _this3.twitter.fetch() : Promise.resolve(null), 
            _this3.instagram ? instagram : Promise.resolve(null), 
            _this3.google ? _this3.google.fetch() : Promise.resolve(null)
          ]
        ).then(function (res) {
          fulfill({
            facebook: res[0] || {},
